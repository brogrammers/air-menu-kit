    ...
    context(@"on error free flow", ^{
        context(@"on find staff member", ^{
            ...
            it(@"creates staff member object", ^{
                [[expectFutureValue(foundStaffMember) shouldEventually] equal:[TestToolBox objectFromJSONFromFile:@"staff_member.json"]];
            });
        });
        ...
        context(@"update staff member", ^{
            ...
            it(@"creates staff member object", ^{
                [[expectFutureValue(updatedStaffMember) shouldEventually] equal:[TestToolBox objectFromJSONFromFile:@"staff_member.json"]];
            });
        ...
        context(@"delete staff member", ^{
            ...
            it(@"creates staff member object", ^{
                [[expectFutureValue(deletedStaffMember) shouldEventually] equal:[TestToolBox objectFromJSONFromFile:@"staff_member.json"]];
            });
        });
    });
});
